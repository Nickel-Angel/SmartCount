...
public class Main1Activity extends Activity implements Camera.PreviewCallback, AlgCallBack{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBar statusBar = new StatusBar(Main1Activity.this);
        statusBar.hide();
    ...
    public void onPause() {
        ...
        if (mCameraUtil.getCameraState() >= 0){
            mCameraUtil.closeCamera();
            Log.i("zhengxing", "MainActivity::onStop the camera is open, close it");
        }
    }
